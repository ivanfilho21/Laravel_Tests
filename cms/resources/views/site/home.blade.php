...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="{{ route('site.index') }}"><img src="{{ asset('evolo/images/logo.svg') }}" alt="alternative"></a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="image-container">
                            <img class="img-fluid" src="{{ asset('evolo/images/header-teamwork.svg') }}" alt="alternative">
